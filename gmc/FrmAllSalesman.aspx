<%@ Page Title="" Language="C#" MasterPageFile="~/Insentive.Master" AutoEventWireup="true" CodeBehind="FrmAllSalesman.aspx.cs" Inherits="gmc.FrmAllSalesman" %>
                   ...
                   <div class="col-sm-2 row mb-2 ">
                    ...
                    <div class="row justify-content-between fv-row">
                        <div class="col-sm-12 row mb-2">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:insentiveConnectionString %>" SelectCommand="PerhitunganBAPALLSalesManCrostab" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="cb_tahun" Name="p_tahun" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                                <Report FileName="ReportAllSalesCrostab.rpt">
                                    <DataSources>
                                        <CR:DataSourceRef DataSourceID="SqlDataSource1" TableName="PerhitunganBAPALLSalesManCrostab;1" />
                                    </DataSources>
                                    <Parameters>
                                        <CR:ControlParameter ControlID="cb_tahun" ConvertEmptyStringToNull="False" DefaultValue="" Name="@p_tahun" PropertyName="SelectedValue" ReportName="" />
                                    </Parameters>
                                </Report>
