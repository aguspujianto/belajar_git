<%@ Page  Language="C#" MasterPageFile="~/Insentive.Master" AutoEventWireup="true" CodeBehind="FrmBAPPeriode_Perinvoice.aspx.cs" Inherits="gmc.FrmBAPPeriode_Perinvoice" ClientTarget="uplevel" Title="Perhitungan BAP"  %>
                        ...
                        <div class="col-sm-6 row mb-2">
                            ...
                            <div class="col-sm-8 mt-1 right-inner-addon">                        
                                <div class="input-group">                                    
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:insentiveConnectionString %>" SelectCommand="SELECT [KodeSales], [NamaSales] FROM [tbl_salesman] where KodeSales not in ('JEL1') order by [NamaSales]"></asp:SqlDataSource>
                                </div>                                
                            </div>
                        </div>                  
                    ...
                    <div class="row justify-content-between fv-row">
                        <div class="col-sm-12 row mb-2">
                            ...
                            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                                <Report FileName="ReportBapPerperiode.rpt">
                                    <DataSources>
