            ...
            <div class="card-body">
                ...
                <div class="row justify-content-between fv-row">
                    <div class="col-sm-12 row mb-2">
                        ...
                        <asp:GridView ID="grv_budgetsales" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="pkey" DataSourceID="sql_budgetsales" CssClass="table table-hover table-responsive" EmptyDataText="Data Not Found" OnLoad="grv_budgetsales_Load" OnRowDataBound="grv_budgetsales_RowDataBound">
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                    <EditItemTemplate>
                                        <asp:LinkButton ID="lnk_update" runat="server" CausesValidation="True" CommandName="Update" Text="Update"></asp:LinkButton>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        &nbsp;<asp:LinkButton ID="lnk_delete" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete"></asp:LinkButton>
                                ...
                                <asp:TemplateField HeaderText="Bulan" SortExpression="Bulan">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("Bulan") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Tahun" SortExpression="Tahun">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("Tahun") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Value" SortExpression="Value">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txt_value" runat="server" Text='<%# Bind("Value","{0:N0}") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label6" runat="server" Text='<%# Bind("Value","{0:N0}") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="tgl_input" SortExpression="tgl_input">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="user_input" SortExpression="user_input">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="tgl_update" SortExpression="tgl_update">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="user_update" SortExpression="user_update">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="pkey" InsertVisible="False" SortExpression="pkey">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label11" runat="server" Text='<%# Bind("pkey") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
